...
class EnginesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engine" do
    assert_difference("Engine.count") do
      post engines_url, params: { engine: { description: @engine.description, image: @engine.image, name: @engine.name, typeengine_id: @engine.typeengine_id } }
    end
  ...
  test "should update engine" do
    patch engine_url(@engine), params: { engine: { description: @engine.description, image: @engine.image, name: @engine.name, typeengine_id: @engine.typeengine_id } }
