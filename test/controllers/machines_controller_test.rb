...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference("Machine.count") do
      post machines_url, params: { machine: { description: @machine.description, image: @machine.image, name: @machine.name, type_engine_id: @machine.type_engine_id } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { description: @machine.description, image: @machine.image, name: @machine.name, type_engine_id: @machine.type_engine_id } }
